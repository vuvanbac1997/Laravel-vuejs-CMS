<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown no-arrow">
            <a  class="flagstrap" data-selected-country="{{strtoupper(\App::getLocale())}}"></a>
        </li>
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                ...
                <form id="signout" method="post" action="{!! URL::action('Admin\AuthController@postSignOut') !!}">{!! csrf_field() !!}
                    <button class="btn btn-secondary" href="">signout</button>
                </form>
